...
<div><a href="/WAPprojectTEK_war_exploded/admin">Refresh</a>

    <button href="" class="button3">Add Product</button>


</div>
<div id="homepageLink"><a href="/WAPprojectTEK_war_exploded/productList">Home Page </a></div>
<div id="admin-logout"><a href="/WAPprojectTEK_war_exploded/logout">Log Out </a></div>
